    ...
    tree =
     Rn(Rn(Rn(Rn(Rn(Rn(Rn(Rn(R(0x0000,0x007F,`ASCII),Empty,0x0080,0x00FF,
                  ...
                  Rn(Rn(Rn(Rn(R(0x0900,0x097F,`Devanagari),Empty,0x0980,
                               0x09FF,`Bengali),
                            Rn(R(0x0A80,0x0AFF,`Gujarati),Empty,0x0B00,
                                0x0B7F,`Oriya),
                            0x0A00,0x0A7F,`Gurmukhi),
                         Rn(Rn(R(0x0C00,0x0C7F,`Telugu),Empty,0x0C80,0x0CFF,
                                `Kannada),
                             R(0x0D80,0x0DFF,`Sinhala),0x0D00,0x0D7F,
                             `Malayalam),
                         0x0B80,0x0BFF,`Tamil),
                      Rn(Rn(Rn(R(0x0E80,0x0EFF,`Lao),Empty,0x0F00,0x0FFF,
                                `Tibetan),
                             R(0x10A0,0x10FF,`Georgian),0x1000,0x109F,
                             `Myanmar),
                          Rn(Rn(R(0x1200,0x137F,`Ethiopic),Empty,0x1380,
                                 0x139F,`Ethiopic_Sup),
                              R(0x1400,0x167F,`UCAS),0x13A0,0x13FF,`Cherokee),
                          0x1100,0x11FF,`Jamo),
                      0x0E00,0x0E7F,`Thai),
                  0x0870,0x08FF,`Arabic_Ext_A),
               Rn(Rn(Rn(Rn(Rn(R(0x16A0,0x16FF,`Runic),Empty,0x1700,0x171F,
                               `Tagalog),
                            Rn(R(0x1740,0x175F,`Buhid),Empty,0x1760,0x177F,
                                `Tagbanwa),
                            0x1720,0x173F,`Hanunoo),
                         Rn(Rn(R(0x1800,0x18AF,`Mongolian),Empty,0x18B0,
                                0x18FF,`UCAS_Ext),
                             R(0x1950,0x197F,`Tai_Le),0x1900,0x194F,`Limbu),
                         0x1780,0x17FF,`Khmer),
                      Rn(Rn(Rn(R(0x19E0,0x19FF,`Khmer_Symbols),Empty,0x1A00,
                                0x1A1F,`Buginese),
                             R(0x1AB0,0x1AFF,`Diacriticals_Ext),0x1A20,
                             0x1AAF,`Tai_Tham),
                          Rn(Rn(R(0x1B80,0x1BBF,`Sundanese),Empty,0x1BC0,
                                 0x1BFF,`Batak),
                              R(0x1C50,0x1C7F,`Ol_Chiki),0x1C00,0x1C4F,
                              `Lepcha),
                          0x1B00,0x1B7F,`Balinese),
                      0x1980,0x19DF,`New_Tai_Lue),
                   Rn(Rn(Rn(Rn(R(0x1C90,0x1CBF,`Georgian_Ext),Empty,0x1CC0,
                                0x1CCF,`Sundanese_Sup),
                             Rn(R(0x1D00,0x1D7F,`Phonetic_Ext),Empty,0x1D80,
                                 0x1DBF,`Phonetic_Ext_Sup),
                             0x1CD0,0x1CFF,`Vedic_Ext),
                          Rn(Rn(R(0x1E00,0x1EFF,`Latin_Ext_Additional),Empty,
                                 0x1F00,0x1FFF,`Greek_Ext),
                              R(0x2070,0x209F,`Super_And_Sub),0x2000,0x206F,
                              `Punctuation),
                          0x1DC0,0x1DFF,`Diacriticals_Sup),
                       Rn(Rn(Rn(R(0x20D0,0x20FF,`Diacriticals_For_Symbols),
                                 Empty,0x2100,0x214F,`Letterlike_Symbols),
                              R(0x2190,0x21FF,`Arrows),0x2150,0x218F,
                              `Number_Forms),
                           Rn(Rn(R(0x2300,0x23FF,`Misc_Technical),Empty,
                                  0x2400,0x243F,`Control_Pictures),
                               R(0x2460,0x24FF,`Enclosed_Alphanum),0x2440,
                               0x245F,`OCR),
                           0x2200,0x22FF,`Math_Operators),
                       0x20A0,0x20CF,`Currency_Symbols),
                   0x1C80,0x1C8F,`Cyrillic_Ext_C),
               0x1680,0x169F,`Ogham),
            Rn(Rn(Rn(Rn(Rn(Rn(R(0x2580,0x259F,`Block_Elements),Empty,0x25A0,
                               0x25FF,`Geometric_Shapes),
                            Rn(R(0x2700,0x27BF,`Dingbats),Empty,0x27C0,
                                0x27EF,`Misc_Math_Symbols_A),
                            0x2600,0x26FF,`Misc_Symbols),
                         Rn(Rn(R(0x2800,0x28FF,`Braille),Empty,0x2900,0x297F,
                                `Sup_Arrows_B),
                             R(0x2A00,0x2AFF,`Sup_Math_Operators),0x2980,
                             0x29FF,`Misc_Math_Symbols_B),
                         0x27F0,0x27FF,`Sup_Arrows_A),
                      Rn(Rn(Rn(R(0x2C00,0x2C5F,`Glagolitic),Empty,0x2C60,
                                0x2C7F,`Latin_Ext_C),
                             R(0x2D00,0x2D2F,`Georgian_Sup),0x2C80,0x2CFF,
                             `Coptic),
                          Rn(Rn(R(0x2D80,0x2DDF,`Ethiopic_Ext),Empty,0x2DE0,
                                 0x2DFF,`Cyrillic_Ext_A),
                              R(0x2E80,0x2EFF,`CJK_Radicals_Sup),0x2E00,
                              0x2E7F,`Sup_Punctuation),
                          0x2D30,0x2D7F,`Tifinagh),
                      0x2B00,0x2BFF,`Misc_Arrows),
                   Rn(Rn(Rn(Rn(R(0x2FF0,0x2FFF,`IDC),Empty,0x3000,0x303F,
                                `CJK_Symbols),
                             Rn(R(0x30A0,0x30FF,`Katakana),Empty,0x3100,
                                 0x312F,`Bopomofo),
                             0x3040,0x309F,`Hiragana),
                          Rn(Rn(R(0x3190,0x319F,`Kanbun),Empty,0x31A0,0x31BF,
                                 `Bopomofo_Ext),
                              R(0x31F0,0x31FF,`Katakana_Ext),0x31C0,0x31EF,
                              `CJK_Strokes),
                          0x3130,0x318F,`Compat_Jamo),
                       Rn(Rn(Rn(R(0x3300,0x33FF,`CJK_Compat),Empty,0x3400,
                                 0x4DBF,`CJK_Ext_A),
                              R(0x4E00,0x9FFF,`CJK),0x4DC0,0x4DFF,`Yijing),
                           Rn(Rn(R(0xA490,0xA4CF,`Yi_Radicals),Empty,0xA4D0,
                                  0xA4FF,`Lisu),
                               R(0xA640,0xA69F,`Cyrillic_Ext_B),0xA500,
                               0xA63F,`Vai),
                           0xA000,0xA48F,`Yi_Syllables),
                       0x3200,0x32FF,`Enclosed_CJK),
                   0x2F00,0x2FDF,`Kangxi),
                Rn(Rn(Rn(Rn(Rn(R(0xA700,0xA71F,`Modifier_Tone_Letters),Empty,
                                0xA720,0xA7FF,`Latin_Ext_D),
                             Rn(R(0xA830,0xA83F,`Indic_Number_Forms),Empty,
                                 0xA840,0xA87F,`Phags_Pa),
                             0xA800,0xA82F,`Syloti_Nagri),
                          Rn(Rn(R(0xA8E0,0xA8FF,`Devanagari_Ext),Empty,
                                 0xA900,0xA92F,`Kayah_Li),
                              R(0xA960,0xA97F,`Jamo_Ext_A),0xA930,0xA95F,
                              `Rejang),
                          0xA880,0xA8DF,`Saurashtra),
                       Rn(Rn(Rn(R(0xA9E0,0xA9FF,`Myanmar_Ext_B),Empty,0xAA00,
                                 0xAA5F,`Cham),
                              R(0xAA80,0xAADF,`Tai_Viet),0xAA60,0xAA7F,
                              `Myanmar_Ext_A),
                           Rn(Rn(R(0xAB00,0xAB2F,`Ethiopic_Ext_A),Empty,
                                  0xAB30,0xAB6F,`Latin_Ext_E),
                               R(0xABC0,0xABFF,`Meetei_Mayek),0xAB70,0xABBF,
                               `Cherokee_Sup),
                           0xAAE0,0xAAFF,`Meetei_Mayek_Ext),
                       0xA980,0xA9DF,`Javanese),
                    Rn(Rn(Rn(Rn(R(0xD7B0,0xDFFF,`Jamo_Ext_B),Empty,0xE000,
                                 0xF8FF,`PUA),
                              Rn(R(0xFB00,0xFB4F,`Alphabetic_PF),Empty,
                                  0xFB50,0xFDFF,`Arabic_PF_A),
                              0xF900,0xFAFF,`CJK_Compat_Ideographs),
                           Rn(Rn(R(0xFE10,0xFE1F,`Vertical_Forms),Empty,
                                  0xFE20,0xFE2F,`Half_Marks),
                               R(0xFE50,0xFE6F,`Small_Forms),0xFE30,0xFE4F,
                               `CJK_Compat_Forms),
                           0xFE00,0xFE0F,`VS),
                        Rn(Rn(Rn(R(0xFF00,0xFFEF,`Half_And_Full_Forms),Empty,
                                  0xFFF0,0xFFFF,`Specials),
                               R(0x10080,0x100FF,`Linear_B_Ideograms),
                               0x10000,0x1007F,`Linear_B_Syllabary),
                            Rn(Rn(R(0x10140,0x1018F,`Ancient_Greek_Numbers),
         ...
         Rn(Rn(Rn(Rn(Rn(Rn(Rn(R(0x102E0,0x102FF,`Coptic_Epact_Numbers),Empty,
                               0x10300,0x1032F,`Old_Italic),
                            Rn(R(0x10350,0x1037F,`Old_Permic),Empty,0x10380,
                                0x1039F,`Ugaritic),
                            0x10330,0x1034F,`Gothic),
                         Rn(Rn(R(0x10400,0x1044F,`Deseret),Empty,0x10450,
                                0x1047F,`Shavian),
                             R(0x104B0,0x104FF,`Osage),0x10480,0x104AF,
                             `Osmanya),
                         0x103A0,0x103DF,`Old_Persian),
                      Rn(Rn(Rn(R(0x10530,0x1056F,`Caucasian_Albanian),Empty,
                                0x10570,0x105BF,`Vithkuqi),
                             R(0x10600,0x1077F,`Linear_A),0x105C0,0x105FF,
                             `Todhri),
                          Rn(Rn(R(0x10800,0x1083F,`Cypriot_Syllabary),Empty,
                                 0x10840,0x1085F,`Imperial_Aramaic),
                              R(0x10880,0x108AF,`Nabataean),0x10860,0x1087F,
                              `Palmyrene),
                          0x10780,0x107BF,`Latin_Ext_F),
                      0x10500,0x1052F,`Elbasan),
                   Rn(Rn(Rn(Rn(R(0x10900,0x1091F,`Phoenician),Empty,0x10920,
                                0x1093F,`Lydian),
                             Rn(R(0x109A0,0x109FF,`Meroitic_Cursive),Empty,
                       ...
                       Rn(Rn(Rn(R(0x10B80,0x10BAF,`Psalter_Pahlavi),Empty,
                                 0x10C00,0x10C4F,`Old_Turkic),
                              R(0x10D00,0x10D3F,`Hanifi_Rohingya),0x10C80,
                              0x10CFF,`Old_Hungarian),
                           Rn(Rn(R(0x10E60,0x10E7F,`Rumi),Empty,0x10E80,
                                  0x10EBF,`Yezidi),
                               R(0x10F00,0x10F2F,`Old_Sogdian),0x10EC0,
                               0x10EFF,`Arabic_Ext_C),
                           0x10D40,0x10D8F,`Garay),
                       0x10B60,0x10B7F,`Inscriptional_Pahlavi),
                   0x108E0,0x108FF,`Hatran),
                Rn(Rn(Rn(Rn(Rn(R(0x10F70,0x10FAF,`Old_Uyghur),Empty,0x10FB0,
                                0x10FDF,`Chorasmian),
                             Rn(R(0x11000,0x1107F,`Brahmi),Empty,0x11080,
                                 0x110CF,`Kaithi),
                             0x10FE0,0x10FFF,`Elymaic),
                          Rn(Rn(R(0x11100,0x1114F,`Chakma),Empty,0x11150,
                                 0x1117F,`Mahajani),
                              R(0x111E0,0x111FF,`Sinhala_Archaic_Numbers),
                              0x11180,0x111DF,`Sharada),
                          0x110D0,0x110FF,`Sora_Sompeng),
                       Rn(Rn(Rn(R(0x11280,0x112AF,`Multani),Empty,0x112B0,
                                 0x112FF,`Khudawadi),
                              R(0x11380,0x113FF,`Tulu_Tigalari),0x11300,
                              0x1137F,`Grantha),
                           Rn(Rn(R(0x11480,0x114DF,`Tirhuta),Empty,0x11580,
                                  0x115FF,`Siddham),
                               R(0x11660,0x1167F,`Mongolian_Sup),0x11600,
                               0x1165F,`Modi),
                           0x11400,0x1147F,`Newa),
                       0x11200,0x1124F,`Khojki),
                    Rn(Rn(Rn(Rn(R(0x116D0,0x116FF,`Myanmar_Ext_C),Empty,
                                 0x11700,0x1174F,`Ahom),
                              Rn(R(0x118A0,0x118FF,`Warang_Citi),Empty,
                                  0x11900,0x1195F,`Dives_Akuru),
                              0x11800,0x1184F,`Dogra),
                           Rn(Rn(R(0x11A00,0x11A4F,`Zanabazar_Square),Empty,
                                  0x11A50,0x11AAF,`Soyombo),
                               R(0x11AC0,0x11AFF,`Pau_Cin_Hau),0x11AB0,
                               0x11ABF,`UCAS_Ext_A),
                           0x119A0,0x119FF,`Nandinagari),
                        Rn(Rn(Rn(R(0x11BC0,0x11BFF,`Sunuwar),Empty,0x11C00,
                                  0x11C6F,`Bhaiksuki),
                               R(0x11D00,0x11D5F,`Masaram_Gondi),0x11C70,
                               0x11CBF,`Marchen),
                            Rn(Rn(R(0x11EE0,0x11EFF,`Makasar),Empty,0x11F00,
                                   0x11F5F,`Kawi),
                                R(0x11FC0,0x11FFF,`Tamil_Sup),0x11FB0,
                                0x11FBF,`Lisu_Sup),
                            0x11D60,0x11DAF,`Gunjala_Gondi),
                        0x11B00,0x11B5F,`Devanagari_Ext_A),
                    0x11680,0x116CF,`Takri),
                0x10F30,0x10F6F,`Sogdian),
             Rn(Rn(Rn(Rn(Rn(Rn(R(0x12400,0x1247F,`Cuneiform_Numbers),Empty,
                                0x12480,0x1254F,`Early_Dynastic_Cuneiform),
                             Rn(R(0x13000,0x1342F,`Egyptian_Hieroglyphs),
                                 Empty,0x13430,0x1345F,
                                 `Egyptian_Hieroglyph_Format_Controls),
                             0x12F90,0x12FFF,`Cypro_Minoan),
                          Rn(Rn(R(0x14400,0x1467F,`Anatolian_Hieroglyphs),
                                 Empty,0x16100,0x1613F,`Gurung_Khema),
                              R(0x16A40,0x16A6F,`Mro),0x16800,0x16A3F,
                              `Bamum_Sup),
                          0x13460,0x143FF,`Egyptian_Hieroglyphs_Ext_A),
                       Rn(Rn(Rn(R(0x16AD0,0x16AFF,`Bassa_Vah),Empty,0x16B00,
                                 0x16B8F,`Pahawh_Hmong),
                              R(0x16E40,0x16E9F,`Medefaidrin),0x16D40,
                              0x16D7F,`Kirat_Rai),
                    ...
                    Rn(Rn(Rn(Rn(R(0x1AFF0,0x1AFFF,`Kana_Ext_B),Empty,0x1B000,
                                 0x1B0FF,`Kana_Sup),
                              Rn(R(0x1B130,0x1B16F,`Small_Kana_Ext),Empty,
                                  0x1B170,0x1B2FF,`Nushu),
                              0x1B100,0x1B12F,`Kana_Ext_A),
                           Rn(Rn(R(0x1BCA0,0x1BCAF,
                                    `Shorthand_Format_Controls),
                                  Empty,0x1CC00,0x1CEBF,
                 ...
                 Rn(Rn(Rn(Rn(Rn(R(0x1E100,0x1E14F,`Nyiakeng_Puachue_Hmong),
                              ...
                              Rn(R(0x1E4D0,0x1E4FF,`Nag_Mundari),Empty,
                                  0x1E5D0,0x1E5FF,`Ol_Onal),
